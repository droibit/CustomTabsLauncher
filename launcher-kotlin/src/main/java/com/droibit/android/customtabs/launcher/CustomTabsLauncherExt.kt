 ...
 */
fun CustomTabsIntent.launch(activity: Activity, uri: String, fallback: ((Activity, Uri)->Unit)? = null) {
    CustomTabsLauncher.launch(activity, this, Uri.parse(uri), fallback)
}
